    ...
    public function up(): void
    {
        if (! Schema::hasTable('quotations')) {
            Schema::create('quotations', function (Blueprint $table) {
                ...
                // No FK to invoices here — avoids circular FK with invoices.quotation_id on MariaDB/cPanel.
        ...
        if (Schema::hasTable('invoices') && ! Schema::hasColumn('invoices', 'quotation_id')) {
            Schema::table('invoices', function (Blueprint $table) {
                // Column only — circular FK to quotations fails on some MariaDB/cPanel setups (errno 150).
